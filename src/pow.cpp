...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    bool postfork = nHeight >= params.BTSQHeight;
    ...
    else if (nHeight < params.BTSQHeight + params.BTSQPremineWindow) {
        return nProofOfWorkLimit;
    }
    else if (nHeight < params.BTSQHeight + params.BTSQPremineWindow + params.nPowAveragingWindow){
...
// Deprecated for Bitcoin Community
...
// Depricated for Bitcoin Community
